...
try:
    ...
    from curtemp_from_sensor import *
except:
    pass
try:
        ...
        while True:
            ...
            try:
                ...
                if(cloud==1):
                    ...
                    mode_cloud=mergedata(firebase.get('/00001/mode_cloud',None))
                    mode_state_cloud=mergedata(firebase.get('/00001/mode_state_cloud',None))
                    if(mode_cloud==0):
                        mode_state='off'
                    elif(mode_cloud==1):
                        mode_state='cool'
                    ...
                    precool_time=mergedata(firebase.get('/00001/precool_time',None))
                    postdata('cloud',0)
                elif(cloud==4):
                    preheat_time=mergedata(firebase.get('/00001/preheat_time',None))
                    postdata('cloud',0)
                elif(cloud==5):
                    ...
                    sleep_time=mergedata(firebase.get('/00001/sleep_time',None))
                    postdata('cloud',0)
                elif(cloud==13):
